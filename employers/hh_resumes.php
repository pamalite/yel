...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employer_headhunter_resumes_page.php";
...
$page = new EmployerHeadhunterResumesPage($_SESSION['yel']['employer']);
$page->header(array('root_dir' => '../', 
                    'title' => 'Recommended Resumes'));
