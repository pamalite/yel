...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_rewards_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/rewards.php');
        exit();
    }
}
...
$home = new EmployeeRewardsPage($_SESSION['yel']['employee']);
$home->header(array('root_dir' => '../', 
                    'title' => 'Rewards'));
$home->insert_employee_rewards_css();
$home->insert_employee_rewards_scripts();
