...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_refer_requests_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/refer_requests.php');
        exit();
    }
}
...
$home->insert_employee_refer_requests_css();
$home->insert_employee_refer_requests_scripts();
