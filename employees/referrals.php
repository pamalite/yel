...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_referrals_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/referrals.php');
        exit();
    }
}
...
$home = new EmployeeReferralsPage($_SESSION['yel']['employee']);
$home->header(array('root_dir' => '../', 
                    'title' => 'Referrals'));
$home->insert_employee_referrals_css();
$home->insert_employee_referrals_scripts();
