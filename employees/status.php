...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_status_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/status.php');
        exit();
    }
}
...
$home = new EmployeeStatusPage($_SESSION['yel']['employee']);
$home->header(array('root_dir' => '../', 
                    'title' => 'Applications Status'));
$home->insert_employee_status_css();
$home->insert_employee_status_scripts();
