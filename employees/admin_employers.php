...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_admin_employers_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/admin_employers.php');
        exit();
    }
}
...
$home = new EmployeeAdminEmployersPage($_SESSION['yel']['employee']);
$home->header(array('root_dir' => '../', 
                    'title' => 'Employers'));
$home->insert_employee_admin_employers_css();
$home->insert_employee_admin_employers_scripts();
