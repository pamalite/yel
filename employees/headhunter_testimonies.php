...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_headhunter_testimonies_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/headhunter_testimonies.php');
        exit();
    }
}
...
$home = new EmployeeHeadhunterTestimoniesPage($_SESSION['yel']['employee']);
$home->header(array('root_dir' => '../', 
                    'title' => 'IRC Testimonies'));
$home->insert_employee_headhunter_testimonies_css();
$home->insert_employee_headhunter_testimonies_scripts();
