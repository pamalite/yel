...
require_once dirname(__FILE__)."/../private/lib/classes/pages/employee_replacements_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/employees/replacements.php');
        exit();
    }
}
...
$home = new EmployeeReplacementsPage($_SESSION['yel']['employee']);
$home->header(array('root_dir' => '../', 
                    'title' => 'Replacements'));
$home->insert_employee_replacements_css();
$home->insert_employee_replacements_scripts();
