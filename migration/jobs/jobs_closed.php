...
indate,
if ((expdate is null), date_add(indate, interval 30 day), expdate) as expiry,
if ((publish = 'R'), 'Y', 'N') as premium_only,
work_location,
jobtitle,
concat(jobscope, ' ', jobreq) as description,
if ((closed_jobpostid = 0), NULL, closed_jobpostid) 
from yel_dev.jobpost_closed where jobpostid not in (select jobpostid from yel_dev.jobpost)";
