...
rteName = "description_textarea";
// Name of the hidden form field.
rteFormName = "description_field";
// Height of the rich text editor.
rteHeight = "300px";
// Path to the images folder.
rteImagePath = "../common/freerte/images/";
// Path to insert form popup.
rteHTMLPathInsertForm = "../common/freerte/html/insert_form.html";
// Path to insert checkbox popup.
rteHTMLPathInsertCheckbox = "../common/freerte/html/insert_checkbox.html";
// Path to insert radio button popup.
rteHTMLPathInsertRadiobutton = "../common/freerte/html/insert_radiobutton.html";
// Path to insert text area popup.
rteHTMLPathInsertTextArea = "../common/freerte/html/insert_textarea.html";
// Path to insert submit button popup.
rteHTMLPathInsertSubmit = "../common/freerte/html/insert_submit.html";
// Path to insert image submit button popup.
rteHTMLPathInsertImageSubmit = "../common/freerte/html/insert_image_submit.html";
// Path to reset form button popup.
rteHTMLPathInsertReset = "../common/freerte/html/insert_reset.html";
// Path to insert hidden form field popup.
rteHTMLPathInsertHidden = "../common/freerte/html/insert_hidden.html";
// Path to insert password field popup.
rteHTMLPathInsertPassword = "../common/freerte/html/insert_password.html";
// Path to insert text field popup.
rteHTMLPathInsertText = "../common/freerte/html/insert_text.html";
// Path to insert table popup.
rteHTMLPathInsertTable = "../common/freerte/html/insert_table.html";
// Path to edit table properties popup.
rteHTMLPathEditTable = "../common/freerte/html/edit_table.html";
// Path to insert link popup.
rteHTMLPathInsertLink = "../common/freerte/html/insert_link.html";
// Path to edit link popup.
rteHTMLPathEditLink = "../common/freerte/html/edit_link.html";
// Path to insert image popup.
rteHTMLPathInsertImage = "../common/freerte/html/insert_image.html";
