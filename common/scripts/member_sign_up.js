...
function sign_up() {
    ...
    var request = new Request({
        ...
        onSuccess: function(txt, xml) {
            ...
            An activation e-mail has been sent to your registered email account to re-activate your account with us. 

            Upon re-activation, please sign in with your registered email address and your newly created password.
