...
class Page {
    ...
    public function insert_scripts() {
        ...
        echo '<script type="text/javascript" src="'. $GLOBALS['protocol']. '://'. $GLOBALS['root']. '/common/scripts/mootools-core.js"></script>'. "\n";
        echo '<script type="text/javascript" src="'. $GLOBALS['protocol']. '://'. $GLOBALS['root']. '/common/scripts/mootools-more.js"></script>'. "\n";
        ...
        if ($type == 'employer') {
            ...
            <div class="menu">
                <ul class="menu">
                    ...
                    <li <?php echo ($page == 'jobs') ? $style : '';?>><a class="menu" href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/employers/jobs.php">Job Descriptions</a></li>
                    ...
                    <li <?php echo ($page == 'profile') ? $style : '';?>><a class="menu" href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/employers/profile.php">Company Profile</a></li>
            ...
            <div class="menu">
                <ul class="menu">
                    ...
                    <li <?php echo ($page == 'job_applications') ? $style : '';?>><a class="menu" href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/members/job_applications.php">Opportunities Explored</a></li>
                    <li <?php echo ($page == 'recommendations') ? $style : '';?>><a class="menu" href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/members/recommendations.php">Recommendations</a></li>
                    <li <?php echo ($page == 'profile') ? $style : '';?>><a class="menu" href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/members/profile.php">My Account</a></li>
