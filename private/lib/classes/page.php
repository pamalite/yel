...
class Page {
    ...
    protected function top_welcome() {
        ?>
        <div class="top">
            <table class="welcome_top">
                <tr>
                    <td class="welcome_logo">
                        <img id="main_logo" src="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/common/images/logos/main.jpg" alt="Yellow Elevator" />
                    </td>
                    <td>
                        <?php
                        ...
                        <div class="welcome_login">
                            ...
                            ?>
                        <div class="welcome_login">
                            Login as an <span style="font-weight: bold;"><a href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/employers">Employer</a></span>
                            or a <span style="font-weight: bold;"><a href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/members">Member</a></span>
                        </div>
                            <?php
                        }
                        ?>
    ...
    protected function menu_employee($_clearances, $page = '') {
        ...
        ?>
                <li <?php echo ($page == 'rewards') ? $style : '';?>><a href="<?php echo $GLOBALS['protocol']. '://'. $GLOBALS['root']; ?>/employees/rewards.php">Rewards</a></li>
        <?php
        }
        ?>
    ...
    protected function support($_employer_id = '') {
        ...
        ?>
            Billing: <span class="phone"><?php echo $phone_number ?></span> (fax: <span class="phone"><?php echo $fax_number ?></span>) or <span class="phone">billing@yellowelevator.com</span>
