...
class EmployeeJobsPage extends Page {
    ...
    public function insert_employee_jobs_css() {
        $this->insert_css();
        
        echo '<link rel="stylesheet" type="text/css" href="'. $GLOBALS['protocol']. '://'. $GLOBALS['root']. '/common/css/employee_jobs.css">'. "\n";
    }
    
    public function insert_employee_jobs_scripts() {
        $this->insert_scripts();
        ...
        echo '<script type="text/javascript" src="'. $GLOBALS['protocol']. '://'. $GLOBALS['root']. '/common/scripts/employee_jobs.js"></script>'. "\n";
    }
    ...
    public function show() {
        $this->begin();
        $this->top_employee($this->employee->get_name(). " - Jobs");
        $this->menu_employee($this->clearances, 'jobs');
            ...
            <div id="div_job_info">
                <table id="job_info" class="job_info">
                    ...
                    <tr>
                        ...
                        <td class="field"><span id="employer.currency_1"></span>$ <span id="job.salary">Loading</span>&nbsp;<span id="job.salary_end">Loading</span>&nbsp;[<span id="job.salary_negotiable">Loading</span>]</td>
                    </tr>
                    <tr>
