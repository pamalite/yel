...
require_once dirname(__FILE__)."/../private/lib/classes/pages/member_recommendations_page.php";

session_start();

if ($GLOBALS['protocol'] == 'https') {
    if (empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == 'off') {
        redirect_to('https://'. $GLOBALS['root']. '/members/recommendations.php');
        exit();
    }
}
...
$home = new MemberRecommendationsPage($_SESSION['yel']['member']);
